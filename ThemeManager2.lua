...
local ThemeManager = {} do
	...
	ThemeManager.BuiltInThemes = {
		['Default'] 		= { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"0e0e0e","AccentColor":"bf8b06","BackgroundColor":"141414","OutlineColor":"323232"}') },
	...
	function ThemeManager:CreateThemeManager(groupbox)
		...
		groupbox:AddLabel('Text')	:AddColorPicker('FontColor', { Default = self.Library.FontColor });
